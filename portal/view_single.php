...
$fetch="SELECT * FROM `single_registration` WHERE `id`={$_GET['id']}";
$fetch=@mysql_query($fetch) or
die("<p class='msg error'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".mysql_error()."</p>");
...
<title><?php echo $row['surname'].", ". $row['firstname'];?> Info</title>
...
<div id="homebody">
  ...
  <td><b><?php echo $row['know'];?></b></td>
    ...
    <p>&nbsp;</p>
    <center>
      <img src="<?php echo "../barcodegen.1d-php5.v5.0.1/test.php?code={$row['regno']}";?>" alt="barcode" height="53" width="445" />
    </center>
